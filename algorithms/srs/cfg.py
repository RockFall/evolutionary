...
class CFG:
    def __init__(self, grammar, n_features=2, max_tree_depth=None, min_tree_depth=None, shortest_path=None):
        ...
        self.n_options_by_non_terminal = {'<start>': 1, '<expr>': 3, '<op>': n_features+5, '<var>': 2}
